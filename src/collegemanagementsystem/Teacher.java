...
public class Teacher extends javax.swing.JFrame {
    ...
    private void jTextField1FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField1FocusGained
        // TODO add your handling code here:
        if(jTextField1.getText().contains("Enter Text Here...."))
        {
            jTextField1.setText("");
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        try
        {
            ...
            String sql = " select * from teacher where id like '%"+search+"%' or firstname like '%"+search+"%' or lastname like '%"+search+"%' or position like '%"+search+"%' or age like '%"+search+"%' or contact like '%"+search+"%' or emailid like '%"+search+"%' or gender like '%"+search+"%' or permanentaddress like '%"+search+"%' or presentaddress like '%"+search+"%' ";
            rs = st.executeQuery(sql);
