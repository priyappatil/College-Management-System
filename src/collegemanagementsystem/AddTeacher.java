...
public class AddTeacher extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jCheckBox1.setBackground(new java.awt.Color(255, 153, 204));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else
        {
            ...
            else
            {
                ...
                try
                {
                    String sql = "insert into teacher(firstname,lastname,position,age,contact,emailid,gender,permanentaddress,presentaddress) values('"+firstname+"','"+lastname+"','"+position+"','"+age+"','"+contact+"','"+emailid+"','"+gender+"','"+permanentaddress+"','"+presentaddress+"')";
